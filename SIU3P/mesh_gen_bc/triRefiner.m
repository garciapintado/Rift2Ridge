function [] = triRefiner(EL2NOD, GCOORD, Point_id, rr, astriangle)
  ...
  if nargin < 5
      astriangle = true;
  end                     %                                                                                  in any of the two conventions: 
                          %                                                                                  |  \ 3 IPs     |     \ 6 IPs
  if astriangle           % 3                   triangle convention [e.g. rift2ridge2D].                     |   \          |      \
    trf = [1 6 5;         % | \                 start by local node 1. Counterclockwise triangles and nodes  |    \         | 5.    \
           6 2 4;         % 5  4                                                                             | .3  \        |        \
           5 4 3;         % |    \                                                                           |      \       | 1.  3.  \
           6 4 5]         % 1--6--2                                                                          |       \      |          \
  else                    % 3                   Burges [e.g. Kinedyn]                                        | .1  .2 \     | 6.  2.  4.\
    trf = [1 4 6;         % | \                                                                              |_________\    |____________\
           4 2 5;         % 6  5
           6 5 3;         % |   \
           4 5 6]         % 1--4--2
  end
