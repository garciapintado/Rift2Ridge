...
for i = 1:length(layer2x)
    ...
    if layer2y(i) <= layer21y + adjust
        layer2y(i) = layer21y + adjust;
        remesh = 1;
        layer_corr(1) = 1;
    end
end
...
for i = 1:length(layer1x)
    ...
    if layer1y(i) + adjust >= layer12y
        layer2y(previndex) = layer2y(previndex) + layer1y(i) - layer12y + adjust;
        layer2y(postindex) = layer2y(postindex) + layer1y(i) - layer12y + adjust;
        remesh = 1;
        layer_corr(2) = 1;
    end
end
